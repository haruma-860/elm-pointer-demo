...
var $author$project$Mouse$statusText = function (model) {
	var s = model.z ? 'Down' : 'Up';
	return s + ($elm$core$String$fromFloat(model.F) + (', ' + $elm$core$String$fromFloat(model.G)));
};
...
var $author$project$Mouse$main = $elm$browser$Browser$sandbox(
	{aD: $author$project$Mouse$init, aR: $author$project$Mouse$update, aS: $author$project$Mouse$view});
